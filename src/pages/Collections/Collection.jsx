...
export const Collection = () => {
  return (
    <AnimatedPage>
      <>
        <main className="collection-content content">
          ...
          <ul className="collection-list container">
            <li className="collection-item--vertical">
              ...
              />
              <p>
                Для съёмки нашей осенней коллекции мы отправились на Кольский
                полуостров – уникальное место с невероятной природой.
              </p>
            </li>
            <li className="collection-item--horizontal">
              ...
              <p>
                ...
                трикотаж, широкое пальто из шерсти, в которое хочется укутаться,
                костюмы тройки в двух цветах – цвета северного моря и песочного
                пляжа, все новые модели созвучны природе севера во всем ее
                многообразии.
              </p>
            </li>
